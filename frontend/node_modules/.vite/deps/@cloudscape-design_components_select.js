...
} from "./chunk-FSFDYXOF.js";
import "./chunk-VZFOHDXE.js";
import {
  internal_default as internal_default4
} from "./chunk-CGISPUT4.js";
import {
  StatusIndicator
} from "./chunk-LLA7743P.js";
import "./chunk-ZRDGI4AO.js";
import {
  joinStrings
} from "./chunk-R63B2VET.js";
import {
  usePrevious
} from "./chunk-VKHHC4CF.js";
import "./chunk-JGTSKDPE.js";
import {
  useDebounceCallback
} from "./chunk-KVEPRYO6.js";
import {
  getExternalProps
...
import {
  ...
  useOpenState
} from "./chunk-NWARID3Y.js";
import "./chunk-XJTSSRB4.js";
import "./chunk-DDFD74SB.js";
import {
  useContainerQuery
} from "./chunk-Q7MDIZAA.js";
import "./chunk-QBOFGJFI.js";
import "./chunk-3WMXAC5M.js";
import "./chunk-JO267CDI.js";
import {
  Tooltip,
  useHiddenDescription
} from "./chunk-Y7DFXZ6X.js";
import "./chunk-7MKVVMLM.js";
import "./chunk-BRKVNGXE.js";
import "./chunk-EYFPKQJE.js";
import {
  KeyCode
} from "./chunk-MA7OWOQM.js";
import "./chunk-CKGIPLIW.js";
import {
  internal_default as internal_default2
} from "./chunk-SKN5CUZC.js";
import {
  useInternalI18n
} from "./chunk-I2BQZHR5.js";
import {
  internal_default
} from "./chunk-XIUOXQVP.js";
import "./chunk-BKLGXFDH.js";
import "./chunk-PB6HLWCF.js";
import {
  scrollElementIntoView
} from "./chunk-UBMA7JFU.js";
import "./chunk-ZUZ2J3IQ.js";
import {
  checkbox_icon_default
} from "./chunk-DKSV2GP7.js";
import {
  useFormFieldContext
} from "./chunk-GGMJCVP5.js";
import {
  useForwardFocus
} from "./chunk-6S5IUCKJ.js";
import "./chunk-ZI4RSSOI.js";
import {
  fireCancelableEvent,
  fireKeyboardEvent,
  fireNonCancelableEvent
} from "./chunk-OGQXEMWU.js";
import "./chunk-TYENEDA2.js";
import {
  getAnalyticsMetadataAttribute
} from "./chunk-FVIW3VT4.js";
import {
  __rest,
  applyDisplayName,
  clsx_m_default,
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/dropdown-status/styles.scoped.css";
...
function DropdownStatus({ children }) {
  return import_react.default.createElement("div", { className: styles_css_default.root }, children);
}
var useDropdownStatus = ({ statusType, empty, loadingText, finishedText, filteringResultsText, errorText, recoveryText, isEmpty, isNoMatch, isFiltered, noMatch, onRecoveryClick, hasRecoveryCallback = false, errorIconAriaLabel }) => {
  ...
  if (statusType === "loading") {
    ...
    statusResult.content = import_react.default.createElement(
      ...
      " ",
      statusResult.hasRecoveryButton && import_react.default.createElement(internal_default4, { onFollow: () => fireNonCancelableEvent(onRecoveryClick), variant: "recovery", className: styles_css_default.recovery }, recoveryText)
    );
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/dropdown-footer/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/internal/components/dropdown-footer/index.js
var DropdownFooter = ({ content, id, hasItems = true }) => import_react2.default.createElement("div", { className: clsx_m_default(styles_css_default2.root, { [styles_css_default2.hidden]: content === null, [styles_css_default2["no-items"]]: !hasItems }) }, content && import_react2.default.createElement(
  internal_default2,
  { id },
  import_react2.default.createElement(dropdown_status_default, null, content)
));
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/select/parts/styles.scoped.css";
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/option/styles.scoped.css";
...
function Highlight({ str }) {
  return str ? import_react4.default.createElement("mark", { className: styles_css_default4["filtering-match-highlight"] }, str) : null;
}
function HighlightMatch({ str, highlightText }) {
  if (!str || !highlightText) {
    return import_react4.default.createElement("span", null, str);
  }
  if (str === highlightText) {
    return import_react4.default.createElement(Highlight, { str });
  }
  const { noMatches, matches } = splitOnFiltering(str, highlightText);
  const highlighted = [];
  noMatches.forEach((noMatch, idx) => {
    highlighted.push(import_react4.default.createElement("span", { key: `noMatch-${idx}` }, noMatch));
    if (matches && idx < matches.length) {
      highlighted.push(import_react4.default.createElement(Highlight, { key: `match-${idx}`, str: matches[idx] }));
    }
  });
  return import_react4.default.createElement("span", null, highlighted);
}

// node_modules/@cloudscape-design/components/internal/components/option/analytics-metadata/styles.css.js
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/option/analytics-metadata/styles.scoped.css";
var styles_css_default5 = {
  "label": "awsui_label_1q5vz_ocied_5"
};

// node_modules/@cloudscape-design/components/internal/components/option/option-parts.js
var Label = ({ label, prefix, highlightText, triggerVariant }) => import_react5.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default4.label, styles_css_default5.label, triggerVariant && styles_css_default4["trigger-variant"]) },
  prefix && import_react5.default.createElement(
    "span",
    { className: clsx_m_default(styles_css_default4["label-prefix"], triggerVariant && styles_css_default4["trigger-variant"]) },
    prefix,
    " "
  ),
  import_react5.default.createElement(HighlightMatch, { str: label, highlightText })
);
var LabelTag = ({ labelTag, highlightText, triggerVariant }) => labelTag ? import_react5.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default4["label-tag"], triggerVariant && styles_css_default4["trigger-variant"]) },
  import_react5.default.createElement(HighlightMatch, { str: labelTag, highlightText })
) : null;
var Description = ({ description, highlightedOption, highlightText, selectedOption, triggerVariant }) => description ? import_react5.default.createElement(
  "span",
  ...
  import_react5.default.createElement(HighlightMatch, { str: description, highlightText })
) : null;
var Tags = ({ tags, highlightedOption, highlightText, selectedOption, triggerVariant }) => tags ? import_react5.default.createElement("span", { className: clsx_m_default(styles_css_default4.tags, {
  [styles_css_default4.highlighted]: highlightedOption,
  [styles_css_default4.selected]: selectedOption
}) }, tags.map((tag, idx) => import_react5.default.createElement(
  "span",
  { key: idx, className: clsx_m_default(styles_css_default4.tag, triggerVariant && styles_css_default4["trigger-variant"]) },
  import_react5.default.createElement(HighlightMatch, { str: tag, highlightText })
))) : null;
var FilteringTags = ({ filteringTags, highlightedOption, highlightText, selectedOption, triggerVariant }) => {
  ...
  return import_react5.default.createElement("span", { className: clsx_m_default(styles_css_default4.tags, {
    [styles_css_default4.highlighted]: highlightedOption,
    [styles_css_default4.selected]: selectedOption
    ...
    if (match) {
      return import_react5.default.createElement(
        ...
        import_react5.default.createElement(HighlightMatch, { str: filteringTag, highlightText })
      );
    }
    return null;
  }));
...
var OptionIcon = (props2) => {
  ...
  return import_react5.default.createElement(
    ...
    import_react5.default.createElement(internal_default, Object.assign({}, props2))
  );
};
...
var Option = (_a) => {
  ...
  const icon = option.__customIcon || import_react6.default.createElement(OptionIcon, { name: option.iconName, url: option.iconUrl, svg: option.iconSvg, alt: option.iconAlt, ariaLabel: option.iconAriaLabel, size: option.description || option.tags ? "big" : "normal" });
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(
      "span",
      { className: styles_css_default4.content },
      import_react6.default.createElement(
        "span",
        { className: styles_css_default4["label-content"] },
        import_react6.default.createElement(Label, { label: (_e = option.label) !== null && _e !== void 0 ? _e : option.value, prefix: option.__labelPrefix, highlightText, triggerVariant }),
        import_react6.default.createElement(LabelTag, { labelTag: option.labelTag, highlightText, triggerVariant })
      ),
      import_react6.default.createElement(Description, { description: option.description, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react6.default.createElement(Tags, { tags: option.tags, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react6.default.createElement(FilteringTags, { filteringTags: option.filteringTags, highlightedOption, selectedOption, highlightText, triggerVariant })
    )
  );
};
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/selectable-item/analytics-metadata/styles.scoped.css";
...
var getAnalyticsSelectActionMetadata = (_a) => {
  ...
  const analyticsMetadata = {
    ...
    detail: {
      label: {
        selector: [`.${styles_css_default5.label}`, `.${styles_css_default6["option-content"]}`]
      }
    }
  };
  let position = void 0;
  ...
  if (isChild) {
    analyticsMetadata.detail.groupLabel = {
      root: "body",
      selector: `.${styles_css_default6.parent}[data-group-index="${dataAttributes["data-group-index"]}"] .${styles_css_default6["option-content"]}`
    };
  }
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/selectable-item/styles.scoped.css";
...
var SelectableItem = (_a, ref) => {
  ...
  const classNames = clsx_m_default(className, styles_css_default7["selectable-item"], {
    [styles_css_default7.selected]: selected,
    [styles_css_default7.highlighted]: highlighted,
    [styles_css_default7["has-background"]]: hasBackground,
    [styles_css_default7.parent]: isParent,
    [styles_css_default6.parent]: isParent,
    [styles_css_default7.child]: isChild,
    [styles_css_default7["select-all"]]: isSelectAll,
    [styles_css_default7["is-keyboard"]]: highlightType === "keyboard",
    [styles_css_default7.disabled]: disabled,
    [styles_css_default7.virtual]: virtualPosition !== void 0 && !sticky,
    [styles_css_default7["pad-bottom"]]: padBottom,
    [styles_css_default7["next-item-selected"]]: isNextSelected,
    [styles_css_default7.interactiveGroups]: useInteractiveGroups,
    [styles_css_default7.sticky]: sticky,
    [styles_css_default7["after-header"]]: !!afterHeader,
    [styles_css_default7["with-scrollbar"]]: withScrollbar,
    [styles_css_default7["visual-refresh"]]: isVisualRefresh
  });
  const contentRef = (0, import_react7.useRef)(null);
  const screenReaderContentRef = (0, import_react7.useRef)(null);
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement("div", { className: clsx_m_default(styles_css_default7["option-content"], styles_css_default6["option-content"]), ref: contentRef }, content),
    import_react7.default.createElement("div", { className: styles_css_default7["measure-strut"], ref }),
    import_react7.default.createElement("div", { className: styles_css_default7["screenreader-content"], ref: screenReaderContentRef })
  );
};
var selectable_item_default = import_react7.default.forwardRef(SelectableItem);
...
var Item = (_a, ref) => {
  ...
  const [canShowTooltip, setCanShowTooltip] = (0, import_react8.useState)(true);
  (0, import_react8.useEffect)(() => setCanShowTooltip(true), [highlighted]);
  return import_react8.default.createElement(
    ...
    import_react8.default.createElement(
      ...
      hasCheckbox && !isParent && import_react8.default.createElement(
        "div",
        { className: styles_css_default3.checkbox },
        import_react8.default.createElement(checkbox_icon_default, { checked: selected || false, disabled: option.disabled })
      ),
      import_react8.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent }),
      !hasCheckbox && !isParent && selected && import_react8.default.createElement(
        "div",
        { className: styles_css_default3["selected-icon"] },
        import_react8.default.createElement(internal_default, { name: "check" })
      ),
      isDisabledWithReason && import_react8.default.createElement(
        import_react8.default.Fragment,
        null,
        descriptionEl,
        highlighted && canShowTooltip && import_react8.default.createElement(Tooltip, { className: styles_css_default3["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true, onDismiss: () => setCanShowTooltip(false) })
      )
    )
  );
};
var item_default = import_react8.default.memo(import_react8.default.forwardRef(Item));
...
var MultiSelectItem = (_a, ref) => {
  ...
  const className = styles_css_default3.item;
  const { descriptionId, descriptionEl } = useHiddenDescription(disabledReason);
  const [canShowTooltip, setCanShowTooltip] = (0, import_react9.useState)(true);
  (0, import_react9.useEffect)(() => setCanShowTooltip(true), [highlighted]);
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      "div",
      { className },
      hasCheckbox && import_react9.default.createElement(
        "div",
        { className: styles_css_default3.checkbox },
        import_react9.default.createElement(checkbox_icon_default, { checked: selected, indeterminate: (isParent || isSelectAll) && indeterminate, disabled })
      ),
      import_react9.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent })
    ),
    isDisabledWithReason && import_react9.default.createElement(
      import_react9.default.Fragment,
      null,
      descriptionEl,
      highlighted && canShowTooltip && import_react9.default.createElement(Tooltip, { className: styles_css_default3["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true, onDismiss: () => setCanShowTooltip(false) })
    )
  );
};
var multiselect_item_default = import_react9.default.memo(import_react9.default.forwardRef(MultiSelectItem));
...
// node_modules/@cloudscape-design/components/select/utils/render-options.js
var renderOptions = ({ options, getOptionProps, filteringValue, highlightType, checkboxes = false, hasDropdownStatus, virtualItems, useInteractiveGroups, screenReaderContent, ariaSetsize, withScrollbar, firstOptionSticky, stickyOptionRef }) => {
...
// node_modules/@cloudscape-design/components/select/parts/plain-list.js
var PlainList = ({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent, firstOptionSticky }, ref) => {
  const stickyOptionRef = (0, import_react11.useRef)(null);
  const [stickyOptionBlockSize, setStickyOptionBlockSize] = (0, import_react11.useState)(firstOptionSticky ? fallbackItemHeight : 0);
  ...
  (0, import_react11.useImperativeHandle)(ref, () => (index) => {
  ...
  return import_react11.default.createElement(
    ...
    listBottom ? import_react11.default.createElement("li", { role: "option", className: styles_css_default3["list-bottom"] }, listBottom) : null
  );
};
var plain_list_default = (0, import_react11.forwardRef)(PlainList);
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/button-trigger/analytics-metadata/styles.scoped.css";
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/components/button-trigger/styles.scoped.css";
...
var ButtonTrigger = (_a, ref) => {
  ...
  const baseProps = getBaseProps(restProps);
  let attributes = Object.assign(Object.assign({}, baseProps), { type: "button", className: clsx_m_default(styles_css_default9["button-trigger"], styles_css_default8["button-trigger"], baseProps.className, pressed && styles_css_default9.pressed, disabled && styles_css_default9.disabled, invalid && styles_css_default9.invalid, warning && !invalid && styles_css_default9.warning, !hideCaret && styles_css_default9["has-caret"], readOnly && styles_css_default9.readonly, inFilteringToken && styles_css_default9["in-filtering-token"], inFilteringToken && styles_css_default9[`in-filtering-token-${inFilteringToken}`], inlineTokens && styles_css_default9["inline-tokens"]), disabled, "aria-expanded": pressed, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, "aria-describedby": ariaDescribedby, "aria-haspopup": ariaHasPopup !== null && ariaHasPopup !== void 0 ? ariaHasPopup : "listbox", "aria-controls": ariaControls, "aria-disabled": readOnly && !disabled ? "true" : void 0, autoFocus });
  if (!readOnly) {
  ...
  return import_react12.default.createElement(
    ...
    children,
    !hideCaret && import_react12.default.createElement(
      "span",
      { className: styles_css_default9.arrow },
      import_react12.default.createElement(internal_default, { name: "caret-down-filled", variant: disabled || readOnly ? "disabled" : "normal" })
    )
  );
};
var button_trigger_default = import_react12.default.forwardRef(ButtonTrigger);

// node_modules/@cloudscape-design/components/select/parts/trigger.js
var Trigger = import_react13.default.forwardRef(({ ariaLabelledby, ariaDescribedby, controlId, invalid, inlineLabelText, warning, triggerProps, selectedOption, selectedOptions, triggerVariant, inFilteringToken, isOpen, placeholder, disabled, readOnly }, ref) => {
  const isVisualRefresh = useVisualRefresh();
  ...
  if (triggerVariant === "tokens") {
    if (selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.length) {
      triggerContent = import_react13.default.createElement(
        "span",
        ...
        import_react13.default.createElement("span", { className: styles_css_default3["inline-token-list"] }, selectedOptions.map(({ label }, i) => import_react13.default.createElement("span", { key: i, className: styles_css_default3["inline-token"] }, label))),
        import_react13.default.createElement(
          "span",
          { className: styles_css_default3["inline-token-counter"], id: triggerContentId },
          import_react13.default.createElement("span", { className: styles_css_default3["inline-token-hidden-placeholder"] }, placeholder),
          import_react13.default.createElement(
            "span",
            null,
            "(",
      ...
      triggerContent = import_react13.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default3.placeholder, styles_css_default3.trigger), id: triggerContentId }, placeholder);
    }
  } else if (!selectedOption) {
    triggerContent = import_react13.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default3.placeholder, styles_css_default3.trigger), id: triggerContentId }, placeholder);
  } else if (triggerVariant === "option") {
    triggerContent = import_react13.default.createElement(option_default, { id: triggerContentId, option: Object.assign(Object.assign({}, selectedOption), { disabled }), triggerVariant: true });
  } else {
    triggerContent = import_react13.default.createElement("span", { id: triggerContentId, className: styles_css_default3.trigger }, selectedOption.label || selectedOption.value);
  }
  const mergedRef = useMergeRefs(triggerProps.ref, ref);
  const triggerButton = import_react13.default.createElement(button_trigger_default, Object.assign({}, triggerProps, { id, ref: mergedRef, pressed: !!isOpen, disabled, readOnly, invalid, warning: warning && !invalid, inFilteringToken, inlineTokens: triggerVariant === "tokens", ariaDescribedby, ariaLabelledby: ariaLabelledbyIds }), triggerContent);
  return import_react13.default.createElement(import_react13.default.Fragment, null, inlineLabelText ? import_react13.default.createElement(
    "div",
    { className: styles_css_default3["inline-label-wrapper"] },
    import_react13.default.createElement("label", { htmlFor: controlId, className: styles_css_default3["inline-label"] }, inlineLabelText),
    import_react13.default.createElement("div", { className: styles_css_default3["inline-label-trigger-wrapper"] }, triggerButton)
  ) : import_react13.default.createElement(import_react13.default.Fragment, null, triggerButton));
});
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react14.default.useLayoutEffect : import_react14.default.useEffect;
function useRect(nodeRef, initialRect) {
  ...
  var _React$useState = import_react14.default.useState(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
  var _React$useReducer = import_react14.default.useReducer(rectReducer, initialRect), rect = _React$useReducer[0], dispatch = _React$useReducer[1];
  var initialRectSet = import_react14.default.useRef(false);
...
function useVirtual(_ref) {
  ...
  var latestRef = import_react14.default.useRef({
    scrollOffset: 0,
    measurements: []
  });
  var _React$useState = import_react14.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
  latestRef.current.scrollOffset = scrollOffset;
  var useMeasureParent = useObserver || useRect;
  var _useMeasureParent = useMeasureParent(parentRef, initialRect), outerSize = _useMeasureParent[sizeKey];
  latestRef.current.outerSize = outerSize;
  var defaultScrollToFn = import_react14.default.useCallback(function(offset) {
    if (parentRef.current) {
      parentRef.current[scrollKey] = offset;
    }
  }, [parentRef, scrollKey]);
  var resolvedScrollToFn = scrollToFn || defaultScrollToFn;
  scrollToFn = import_react14.default.useCallback(function(offset) {
    resolvedScrollToFn(offset, defaultScrollToFn);
  }, [defaultScrollToFn, resolvedScrollToFn]);
  var _React$useState2 = import_react14.default.useState({}), measuredCache = _React$useState2[0], setMeasuredCache = _React$useState2[1];
  var measure = import_react14.default.useCallback(function() {
    return setMeasuredCache({});
  }, []);
  var pendingMeasuredCacheIndexesRef = import_react14.default.useRef([]);
  var measurements = import_react14.default.useMemo(function() {
  ...
  var scrollOffsetFnRef = import_react14.default.useRef(scrollOffsetFn);
  ...
  var indexes = import_react14.default.useMemo(function() {
  ...
  var measureSizeRef = import_react14.default.useRef(measureSize);
  measureSizeRef.current = measureSize;
  var virtualItems = import_react14.default.useMemo(function() {
    var virtualItems2 = [];
  ...
  var mountedRef = import_react14.default.useRef(false);
  useIsomorphicLayoutEffect(function() {
  ...
  var scrollToOffset = import_react14.default.useCallback(function(toOffset, _temp) {
  ...
  var tryScrollToIndex = import_react14.default.useCallback(function(index, _temp2) {
  ...
  var scrollToIndex = import_react14.default.useCallback(function() {
...
function useVirtual2({ items, parentRef, estimateSize, firstItemSticky }) {
  ...
  const measuresCache = (0, import_react15.useRef)(/* @__PURE__ */ new WeakMap());
  ...
  const virtualItems = (0, import_react15.useMemo)(() => rowVirtualizer.virtualItems.map((virtualItem) => Object.assign(Object.assign({}, virtualItem), { measureRef: (node) => {
    var _a;
...
var VirtualList = (props2, ref) => {
  return props2.menuProps.open ? import_react16.default.createElement(VirtualListOpen, Object.assign({}, props2, { ref })) : import_react16.default.createElement(VirtualListClosed, Object.assign({}, props2, { ref }));
};
var VirtualListOpen = (0, import_react16.forwardRef)(({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent, firstOptionSticky }, ref) => {
  const [width, menuMeasureRef] = useContainerQuery((rect) => ({ inner: rect.contentBoxWidth, outer: rect.borderBoxWidth }), []);
  const menuRefObject = (0, import_react16.useRef)(null);
  const menuRef = useMergeRefs(menuMeasureRef, menuRefObject, menuProps.ref);
  const previousHighlightedIndex = (0, import_react16.useRef)();
  const { virtualItems, totalSize, scrollToIndex } = useVirtual2({
    ...
    estimateSize: (0, import_react16.useCallback)(() => fallbackItemHeight, [width === null || width === void 0 ? void 0 : width.inner, filteringValue]),
  ...
  return import_react16.default.createElement(
    ...
    finalOptions,
    import_react16.default.createElement("div", { "aria-hidden": "true", key: "total-size", className: styles_css_default3["layout-strut"], style: { height: totalSize - stickySize } }),
    listBottom ? import_react16.default.createElement("li", { role: "option", className: styles_css_default3["list-bottom"] }, listBottom) : null
  );
});
var VirtualListClosed = (0, import_react16.forwardRef)(({ menuProps, listBottom }, ref) => {
  (0, import_react16.useImperativeHandle)(ref, () => () => {
  }, []);
  return import_react16.default.createElement(options_list_default, Object.assign({}, menuProps, { ref: menuProps.ref }), listBottom ? import_react16.default.createElement("li", { role: "option", className: styles_css_default3["list-bottom"] }, listBottom) : null);
});
var virtual_list_default = (0, import_react16.forwardRef)(VirtualList);
...
function useAnnouncement({ highlightText, announceSelected, highlightedOption, getParent, selectedAriaLabel, renderHighlightedAriaLive }) {
  const prevAnnouncedGroup = (0, import_react17.useRef)(void 0);
...
function useNativeSearch({ isEnabled, options, highlightOption, highlightedOption, useInteractiveGroups }) {
  const value = (0, import_react19.useRef)("");
...
function useHighlightedOption({ options, isHighlightable }) {
  const [highlightedIndex, setHighlightedIndexState] = (0, import_react20.useState)(-1);
  const [highlightType, setHighlightType] = (0, import_react20.useState)(new HighlightType("keyboard"));
  const setHighlightedIndex = (0, import_react20.useCallback)((index, newHighlightType) => {
  ...
  const highlightOption = (0, import_react20.useCallback)((option, highlightType2) => {
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/select/styles.scoped.css";
var styles_css_default10 = {
  "root": "awsui_root_r2vco_1yzpb_145"
};

// node_modules/@cloudscape-design/components/select/internal.js
var InternalSelect = import_react22.default.forwardRef((_a, externalRef) => {
  var _b;
  ...
  const [filteringValue, setFilteringValue] = (0, import_react22.useState)("");
  ...
  const scrollToIndex = (0, import_react22.useRef)(null);
  ...
  const filter = import_react22.default.createElement(filter_default, Object.assign({ clearAriaLabel: filteringClearAriaLabel, filteringType, placeholder: filteringPlaceholder, ariaLabel: filteringAriaLabel, ariaRequired, value: filteringValue }, getFilterProps()));
  const trigger = import_react22.default.createElement(trigger_default, Object.assign({ ref: triggerRef, placeholder, disabled, readOnly, triggerVariant, triggerProps: getTriggerProps(disabled, autoFocus), selectedOption, isOpen, inFilteringToken: __inFilteringToken, inlineLabelText }, formFieldContext, { controlId, ariaLabelledby: joinStrings(formFieldContext.ariaLabelledby, selectAriaLabelId) }));
  ...
  return import_react22.default.createElement(
    "div",
    Object.assign({}, baseProps, { ref: mergedRef, className: clsx_m_default(styles_css_default10.root, baseProps.className), onKeyDown: handleNativeSearch }),
    import_react22.default.createElement(
      dropdown_default,
      Object.assign({}, dropdownProps, { ariaLabelledby: dropdownProps.dropdownContentRole ? joinStrings(selectAriaLabelId, controlId) : void 0, ariaDescribedby: dropdownProps.dropdownContentRole ? dropdownStatus.content ? footerId : void 0 : void 0, open: isOpen, stretchTriggerHeight: !!__inFilteringToken, stretchBeyondTriggerWidth: true, trigger, header: filter, onMouseDown: handleMouseDown, footer: dropdownStatus.isSticky ? import_react22.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, expandToViewport }),
      import_react22.default.createElement(ListComponent, { listBottom: !dropdownStatus.isSticky ? import_react22.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, menuProps, getOptionProps, filteredOptions, filteringValue, ref: scrollToIndex, hasDropdownStatus: dropdownStatus.content !== null, screenReaderContent: announcement, highlightType })
    ),
    import_react22.default.createElement("div", { hidden: true, id: selectAriaLabelId }, ariaLabel || inlineLabelText)
  );
});
var internal_default5 = InternalSelect;

// node_modules/@cloudscape-design/components/select/index.js
var Select = import_react23.default.forwardRef((_a, ref) => {
  ...
  const componentAnalyticsMetadata = {
    name: "awsui.Select",
    label: `.${styles_css_default8["button-trigger"]}`,
    properties: {
      disabled: `${!!externalProps.disabled}`
    }
  };
  return import_react23.default.createElement(internal_default5, Object.assign({ options, filteringType, statusType, triggerVariant }, externalProps, baseComponentProps, { ref }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata })));
});
