...
function createSingletonState({ factory, initialState }) {
  ...
  return function useSingletonState() {
    const [state, setState] = (0, import_react7.useState)(value);
...
function useCurrentMode(elementRef) {
  const [value, setValue] = (0, import_react8.useState)("light");
...
function useDensityMode(elementRef) {
  const [value, setValue] = (0, import_react8.useState)("comfortable");
  useMutationObserver(elementRef, (node) => {
...
function useReducedMotion(elementRef) {
  const [value, setValue] = (0, import_react8.useState)(false);
  useMutationObserver(elementRef, (node) => {
...
var SingleTabStopNavigationProvider = (0, import_react10.forwardRef)(({ navigationActive, children, getNextFocusTarget, isElementSuppressed, onRegisterFocusable, onUnregisterActive }, ref) => {
  ...
  return import_react10.default.createElement(SingleTabStopNavigationContext.Provider, { value: { navigationActive, registerFocusable } }, children);
});
...
var PACKAGE_VERSION = "3.0.0 (33bce10c)";
var GIT_SHA = "33bce10c";
...
import "/Users/ayg/errand-app/frontend/node_modules/@cloudscape-design/components/internal/base-component/styles.scoped.css";
...
//# sourceMappingURL=chunk-5AELL656.js.map
